...
import { BATCH_SIZE, DEFAULT_EMAIL, RESPONSE_ERROR_HEADERS } from './constants';
...
export class ProductServiceStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const authLambdaIntegrationOptions = {
      authorizationType: AuthorizationType.COGNITO,
      authorizer,
      authorizationScopes: ['openid', 'profile', 'email'],
    };
    ...
    deleteProductByIdLambdaHandler.addToRolePolicy(
      new iam.PolicyStatement({
    ...
    products.addMethod(
      httpMethod.PUT,
      new LambdaIntegration(putProductLambdaHandler),
      authLambdaIntegrationOptions,
    );
    product_id.addMethod(
      httpMethod.DELETE,
      new LambdaIntegration(deleteProductByIdLambdaHandler),
      authLambdaIntegrationOptions,
    );
    products.addMethod(
      httpMethod.POST,
      new LambdaIntegration(postProductLambdaHandler),
      authLambdaIntegrationOptions,
    );
